        ...
        {filterOrder.map((filter) => {
          ...
          return (
            <button
              ...
              className={`focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 relative z-10 max-w-full break-words rounded-full border px-3 py-2 text-left text-xs font-medium transition-colors ${
                isActive
